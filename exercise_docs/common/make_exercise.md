...
- [演習を作る](#演習を作る)
  - [ディレクトリ構成](#ディレクトリ構成)
  - [環境の違い(演習用と演習作成用)](#環境の違い演習用と演習作成用)
  - [演習ネットワークの作成](#演習ネットワークの作成)
    - [演習スクリプトのデバッグ](#演習スクリプトのデバッグ)
    - [演習ネットワーク定義ファイルの作成と整合性テスト](#演習ネットワーク定義ファイルの作成と整合性テスト)
  - [演習ドキュメントの作成](#演習ドキュメントの作成)
    - [ローカルWebサーバを起動してドキュメント参照](#ローカルwebサーバを起動してドキュメント参照)
    - [Markdownの自動目次挿入](#markdownの自動目次挿入)
    - [ヘッダ・フッタの挿入](#ヘッダ・フッタの挿入)
    - [演習ドキュメントの日本語チェック](#演習ドキュメントの日本語チェック)
    - [MarkdownをPDFに変換する](#markdownをpdfに変換する)
  - [演習ネットワーク定義](#演習ネットワーク定義)
  - [TODO](#todo)
